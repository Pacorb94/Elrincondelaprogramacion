...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [0 => function () {
            return ($this->privates['acme_api.event.authentication_success_listener'] ?? ($this->privates['acme_api.event.authentication_success_listener'] = new \App\Event\AuthenticationSuccessListener()));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2sCMcjHfyo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.qM8a9Nc'] ?? $this->get_ServiceLocator_QM8a9NcService()), new RewindableGenerator(function () {
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'profileImagesDirectory' => (\dirname(__DIR__, 4).'/public/profile-images'),
            'postsImagesDirectory' => (\dirname(__DIR__, 4).'/public/images-posts'),
